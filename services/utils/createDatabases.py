...
class clientFinancialDatabase:
    # sample client financial data
    data = {
        "client-001": {"nom": "John Doe", "adresse": "123 Main St", "revenu_mensuel": 4000, "depense_mensuel": 3000},
    ...
    def get_client_financial_data(cls, client_id):
        """Retrieve client monthky income and expenses based on client ID"""
        client_data = cls.data.get(client_id, {})
